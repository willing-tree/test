...
class FewRelProcessor():
    ...
    def _init_rel2id_relations(self):
        ...
        for key, _ in pid2name:
            ...
            # # 手动添加 'per:cities_of_residence'
            # #运行zwl
            # if 'per:cities_of_residence' not in rel2id:
            #     rel2id['per:cities_of_residence'] = len(relations)
    ...
    def set_task_order(self, filename, index):
        ...
        # # 手动添加 'per:cities_of_residence'
        # #运行zwl
        # if 'per:cities_of_residence' not in self.relations:
        #         self.relations.append('per:cities_of_residence')
    ...
    def _read_data_from_order(self, filename):
        ...
        for key, value in data.items():
            for instance in value:
                ...
                # 确保 key 在 rel2id 中,运行zwl
                # if key not in self.rel2id:
                #     self.rel2id[key] = len(self.rel2id)
